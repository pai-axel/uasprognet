...
@section('title', 'Jumlah Divisi | Yayasan Mentari Meraki Asa')
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel wedo_owl_carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="/upload/assets/wedo-img1.jpg" alt="" />
              </div>
          ...
          <div class="item">
            <div class="box ">
              <div class="img-box">
                <img src="/upload/assets/wedo-img2.jpg" alt="" />
              </div>
              <div class="detail-box">
                <h5>
                  Caring & Planting
          ...
          <div class="item">
            <div class="box ">
              <div class="img-box">
                <img src="/upload/assets/wedo-img3.jpg" alt="" />
              </div>
              <div class="detail-box">
                <h5>
                  Spring & Fall Cleanup
